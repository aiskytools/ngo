          ...
          <div className="grid lg:grid-cols-[1.1fr_1fr] gap-12 items-start">
            ...
            <AnimatedSection>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <input name="fullName" required maxLength={200} placeholder="Full Name *" aria-label="Full name" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                <input name="phone" required type="tel" maxLength={20} placeholder="Phone *" aria-label="Phone" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                <input name="email" type="email" maxLength={254} placeholder="Email (for receipt)" aria-label="Email for receipt" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500" />
                <select name="fund" defaultValue="General Fund" aria-label="Donation fund" className="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500">
